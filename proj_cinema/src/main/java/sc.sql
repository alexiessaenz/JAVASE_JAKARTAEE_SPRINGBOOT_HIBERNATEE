...
INSERT INTO cine1.actor
(FNacimiento, LNacimiento, Nacionalidad, Nombre)
VALUES(
	'1993-01-12',
	'Bo la Pila, Meanguera',
	'Salvadorenio',
	'Moises Saenz'
);
...
INSERT INTO cine1.ganaPremio
(CodPelicula, CodPremio, Anyo)
VALUES (4,1,2001),(4,2,2001),(5,3,2002),(5,4,2002),(5,5,2002),(5,6,2002),(6,3,2005),(6,4,2005),(6,5,2005),(6,7,2005),(6,9,2005),(6,10,2004),(6,11,2004),(6,12,2005),(6,13,2005),(6,14,2005),(6,15,2005),(6,16,2005),(6,22,2005),(6,23,2004),(6,24,2005),(7,7,1943),(7,10,1943),(7,17,1943),(8,7,2001),(8,9,2001),(8,19,2001),(10,2,1999),(10,9,2000),(10,13,2000),(10,16,2000),(10,19,2000),(10,20,2000);

INSERT INTO cine1.participa
( CodActor, CodPelicula)
VALUES (1,3),(2,4),(3,4),(4,5),(5,5),(6,5),(7,6),(8,6),(9,6),(10,7),(11,7),(12,8),(13,9),(14,9),(15,10),(16,10),(6,13),(35,13);

DROP table participa;
-- cine1.participa definition

CREATE TABLE `participa` (
  `CodPelicula` bigint NOT NULL,
  `CodActor` bigint NOT NULL,
  KEY `FK2i4xehs6pv2jmr2ou8ncl0aij` (`CodPelicula`),
  CONSTRAINT `FK2i4xehs6pv2jmr2ou8ncl0aij` FOREIGN KEY (`CodPelicula`) REFERENCES `pelicula` (`CodPelicula`),
  CONSTRAINT `FKqkvm0nis7m6600tsu4fywfnoi` FOREIGN KEY (`CodActor`) REFERENCES `actor` (`CodActor`)
